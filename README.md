# Collector for Climate Hazard Center (CHC) (UC Santa Barbara) Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-chc_ucsb/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-chc_ucsb/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-chc_ucsb/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-chc_ucsb?branch=main)
 ...
 **hdx-scraper-chc_ucsb** as specified in the parameter
 *user_agent_lookup*.
